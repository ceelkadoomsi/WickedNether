...
public class WickedFungus2Feature extends Feature<NoneFeatureConfiguration> {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("addonity:wicked_fungus_2", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("addonity:wicked_fungus_2", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
