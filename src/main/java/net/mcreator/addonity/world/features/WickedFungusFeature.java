...
public class WickedFungusFeature extends Feature<NoneFeatureConfiguration> {
	public static WickedFungusFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new WickedFungusFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("addonity:wicked_fungus", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("addonity:wicked_fungus", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
