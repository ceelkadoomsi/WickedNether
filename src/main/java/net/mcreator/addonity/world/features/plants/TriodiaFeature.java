...
public class TriodiaFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("addonity:triodia", FEATURE, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK,
				new SimpleBlockConfiguration(BlockStateProvider.simple(AddonityModBlocks.TRIODIA.get().defaultBlockState())), List.of(), 18));
		PLACED_FEATURE = PlacementUtils.register("addonity:triodia", CONFIGURED_FEATURE,
