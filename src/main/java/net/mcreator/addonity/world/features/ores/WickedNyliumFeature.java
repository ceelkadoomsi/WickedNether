...
public class WickedNyliumFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("addonity:wicked_nylium", FEATURE,
				new OreConfiguration(WickedNyliumFeatureRuleTest.INSTANCE, AddonityModBlocks.WICKED_NYLIUM.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("addonity:wicked_nylium", CONFIGURED_FEATURE,
	...
	private static class WickedNyliumFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("addonity:wicked_nylium_match"), CUSTOM_MATCH);
		}
