...
public class WickedFungus3Feature extends Feature<NoneFeatureConfiguration> {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("addonity:wicked_fungus_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("addonity:wicked_fungus_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
