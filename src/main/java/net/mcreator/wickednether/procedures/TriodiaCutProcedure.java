...
public class TriodiaCutProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.SHEARS) {
			...
			if (world instanceof ServerLevel _level && _level.getServer() != null) {
				Optional<CommandFunction> _fopt = _level.getServer().getFunctions().get(new ResourceLocation("wicked_nether:triodia_cut"));
				if (_fopt.isPresent())
			...
			world.levelEvent(2001, new BlockPos(x, y, z), Block.getId(WickedNetherModBlocks.TRIODIA.get().defaultBlockState()));
