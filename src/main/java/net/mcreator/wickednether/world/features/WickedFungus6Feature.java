...
public class WickedFungus6Feature extends Feature<NoneFeatureConfiguration> {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("wicked_nether:wicked_fungus_6", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wicked_nether:wicked_fungus_6", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
