...
public class WickedFungus5Feature extends Feature<NoneFeatureConfiguration> {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("wicked_nether:wicked_fungus_5", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wicked_nether:wicked_fungus_5", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
