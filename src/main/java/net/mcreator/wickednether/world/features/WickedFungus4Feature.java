...
import net.mcreator.wickednether.procedures.WickedFungusDopolnitielnoieUsloviieGienieratsiiProcedure;
...
public class WickedFungus4Feature extends Feature<NoneFeatureConfiguration> {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("wicked_nether:wicked_fungus_4", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wicked_nether:wicked_fungus_4", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
