...
public class WickedForestBiome {
	...
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-12250266).waterColor(4159204).waterFogColor(329011)
				...
				.ambientParticle(new AmbientParticleSettings((SimpleParticleType) (WickedNetherModParticleTypes.WICKED_DAST.get()), 0.2f)).build();
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(WickedNetherModBiomes.WICKED_FOREST.get())),
